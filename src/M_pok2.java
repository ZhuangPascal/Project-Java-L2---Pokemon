...
public class M_pok2 extends JPanel{
	...
	public M_pok2(Fenetre f, Combat c, JPanel jp, Menu_P mp, Sac s) {
		this.s=s;
		this.f=f;
		this.c=c;
		this.jp=jp;
	...
	public class EcouteurBoutonChanger implements ActionListener{ 
        ...
        public void actionPerformed(ActionEvent clic) {
        	...
        	if(c.getD().getTabP()[i].getHp()>=c.getD().getTabP()[i].getHpMax()) 
				...
				c.getD().getTabP()[i].setHp(c.getD().getTabP()[i].getHp()+((c.getD().getTabP()[i].getHpMax()*50)/100));								
				c.getD().setPotion(c.getD().getPotion()-1);
				M_pok2.this.mp.setL("                                                                             "+c.getPd1().getNom()+": "+c.getPd1().getHp()+" HP"+"                                                                                                                                                            "+c.getPd2().getNom()+": "+c.getPd2().getHp()+" HP");
        		...
        		s.setB1("Potion  x"+(c.getD().getPotion()));
			}
        }
    }
